...
async function main(){
  ...
  // await sleep(100000)
  // let txinfo = await api.getTransaction(txhash.tx_json.hash)
  // console.log("txinfo:", txinfo)

  // info = await api.getAccountInfo(from.addr)
  // console.log(JSON.stringify(info,null,2));
  // info = await api.getAccountInfo(dest.addr)
  // console.log(JSON.stringify(info,null,2));
  // let balance = await api.getBalances(dest.addr);
  // console.log("dest addr balance:", balance)
