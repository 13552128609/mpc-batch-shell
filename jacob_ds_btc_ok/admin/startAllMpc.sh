...
if [ ${index} -lt 18 ];then
	...
	nohup ../bin/schnorrmpc --verbosity 3 --port $p2pPort  --storeman  --datadir $datadir --keystore $ksdir --password ../conf/cfg/pwd.json --ipcpath $datadir/mpc.ipc --maxpeers 500 --nodekey $datadir/nodekey --threshold 17 --totalnodes 21  --bootnodes "enode://227ea0bbf86764014a1bc0d123ee18edc6e79b5e602f2f4706a985369bbfc7cfd91f2a14f1c71aad137c814abf6659342213fb7c4af1eb114dea37d51d6e0fbf@127.0.0.1:30000" --sysloglevel INFO --mpc.tolerance 3  --mpc.maxcontext 20 --mpc.approvingtimeout 1h --mpc.approvingcleanupcycle 1h >  /tmp/node${index} 2>&1 &
	#add maxhashdatalen
	#nohup ../bin/schnorrmpc --verbosity 3 --port $p2pPort  --storeman  --datadir $datadir --keystore $ksdir --password ../conf/cfg/pwd.json --ipcpath $datadir/mpc.ipc --maxpeers 500 --nodekey $datadir/nodekey --threshold 17 --totalnodes 21  --bootnodes "enode://227ea0bbf86764014a1bc0d123ee18edc6e79b5e602f2f4706a985369bbfc7cfd91f2a14f1c71aad137c814abf6659342213fb7c4af1eb114dea37d51d6e0fbf@127.0.0.1:30000" --sysloglevel INFO --mpc.tolerance 3  --mpc.maxcontext 20 --mpc.approvingtimeout 1h --mpc.approvingcleanupcycle 1h --mpc.maxhashdatalen 1 >  /tmp/node${index} 2>&1 &
	

else
	nohup ../bin/schnorrmpc --verbosity 3 --port $p2pPort --storeman  --datadir $datadir --keystore $ksdir --password ../conf/cfg/pwd.json --ipcpath $datadir/mpc.ipc --maxpeers 500 --nodekey $datadir/nodekey --threshold 17 --totalnodes 21  --bootnodes "enode://227ea0bbf86764014a1bc0d123ee18edc6e79b5e602f2f4706a985369bbfc7cfd91f2a14f1c71aad137c814abf6659342213fb7c4af1eb114dea37d51d6e0fbf@127.0.0.1:30000" --sysloglevel INFO --mpc.tolerance 3  --mpc.maxcontext 20 --mpc.approvingtimeout 1h --mpc.approvingcleanupcycle 1h >  /tmp/node${index} 2>&1 &
	#nohup ~/schnorrmpcV11.0.5 --verbosity 3 --port $p2pPort --storeman  --datadir $datadir --keystore $ksdir --password ../conf/cfg/pwd.json --ipcpath $datadir/mpc.ipc --maxpeers 500 --nodekey $datadir/nodekey --threshold 17 --totalnodes 21  --bootnodes "enode://227ea0bbf86764014a1bc0d123ee18edc6e79b5e602f2f4706a985369bbfc7cfd91f2a14f1c71aad137c814abf6659342213fb7c4af1eb114dea37d51d6e0fbf@127.0.0.1:30000" --sysloglevel INFO --mpc.tolerance 3  --mpc.maxcontext 20 --mpc.approvingtimeout 1h --mpc.approvingcleanupcycle 1h >  /tmp/node${index} 2>&1 &
fi
  ((index++))
